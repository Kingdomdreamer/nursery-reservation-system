"use strict";exports.id=751,exports.ids=[751],exports.modules={9241:(e,s,t)=>{t.d(s,{Z:()=>c});var a=t(326),i=t(7577),l=t(434),n=t(5047);let r=[{href:"/admin",label:"ダッシュボード",icon:"bi-speedometer2",description:"概要とメトリクス"},{href:"/admin/reservations",label:"予約管理",icon:"bi-calendar-check",description:"予約の確認と管理"},{href:"/admin/products",label:"商品管理",icon:"bi-box-seam",description:"商品と在庫の管理"},{href:"/admin/customers",label:"顧客管理",icon:"bi-people",description:"顧客情報の管理"},{href:"/admin/forms",label:"フォーム管理",icon:"bi-file-earmark-text",description:"予約フォームの設定"},{href:"/admin/notifications",label:"通知管理",icon:"bi-bell",description:"通知とメッセージ"}];function c({children:e}){let[s,t]=(0,i.useState)(!1),[c,o]=(0,i.useState)(!1),d=(0,n.usePathname)(),m=e=>"/admin"===e?"/admin"===d:d.startsWith(e);return(0,a.jsxs)("div",{className:"d-flex",children:[s&&a.jsx("div",{className:"position-fixed w-100 h-100 d-lg-none",style:{backgroundColor:"rgba(0,0,0,0.5)",zIndex:1040},onClick:()=>t(!1)}),a.jsx("nav",{className:`bg-white border-end shadow-sm position-fixed ${s?"d-block":"d-none d-lg-block"}`,style:{width:"280px",height:"100vh",zIndex:1030,left:0,top:0},children:(0,a.jsxs)("div",{className:"d-flex flex-column h-100",children:[a.jsx("div",{className:"p-4 border-bottom",children:a.jsx(l.default,{href:"/admin",className:"text-decoration-none",children:(0,a.jsxs)("div",{className:"d-flex align-items-center",children:[a.jsx("div",{className:"bg-primary rounded-3 p-2 me-3",children:a.jsx("i",{className:"bi bi-flower3 text-white fs-4"})}),(0,a.jsxs)("div",{children:[a.jsx("h5",{className:"mb-0 text-dark fw-bold",children:"種苗店管理"}),a.jsx("small",{className:"text-muted",children:"予約システム"})]})]})})}),a.jsx("div",{className:"flex-grow-1 overflow-auto",children:a.jsx("ul",{className:"nav flex-column",children:r.map(e=>a.jsx("li",{className:"nav-item",children:(0,a.jsxs)(l.default,{href:e.href,className:`nav-link d-flex align-items-center py-3 px-4 text-dark text-decoration-none ${m(e.href)?"bg-primary-subtle text-primary border-end border-primary border-3":""}`,onClick:()=>t(!1),children:[a.jsx("i",{className:`${e.icon} me-3`}),(0,a.jsxs)("div",{children:[a.jsx("div",{className:"fw-medium",children:e.label}),a.jsx("small",{className:"text-muted d-block",children:e.description})]})]})},e.href))})}),a.jsx("div",{className:"p-4 border-top",children:(0,a.jsxs)("div",{className:"d-flex align-items-center text-muted",children:[a.jsx("i",{className:"bi bi-person-circle me-2"}),a.jsx("small",{children:"管理者"})]})})]})}),(0,a.jsxs)("main",{className:"flex-grow-1",style:{marginLeft:c?"280px":"0"},children:[a.jsx("header",{className:"bg-white border-bottom shadow-sm sticky-top",style:{height:"64px",zIndex:1020},children:(0,a.jsxs)("div",{className:"d-flex align-items-center justify-content-between w-100 h-100 px-4",children:[(0,a.jsxs)("div",{className:"d-flex align-items-center",children:[a.jsx("button",{className:"btn btn-light d-lg-none me-3",onClick:()=>t(!s),children:a.jsx("i",{className:"bi bi-list fs-4 text-dark"})}),a.jsx("h4",{className:"mb-0 text-dark",children:r.find(e=>m(e.href))?.label||"ダッシュボード"})]}),(0,a.jsxs)("div",{className:"d-flex align-items-center",children:[(0,a.jsxs)("button",{className:"btn btn-outline-light text-muted me-3 position-relative",children:[a.jsx("i",{className:"bi bi-bell fs-5"}),a.jsx("span",{className:"position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger",style:{fontSize:"0.6rem"},children:"3"})]}),a.jsx("button",{className:"btn btn-outline-light text-muted",children:a.jsx("i",{className:"bi bi-gear fs-5"})})]})]})}),a.jsx("div",{className:"p-4",children:e})]})]})}},3137:(e,s,t)=>{t.d(s,{Z:()=>o});var a=t(326),i=t(7577),l=t(5442),n=t(1058);class r{static{this.config={lineEnabled:!0,emailEnabled:!0,smsEnabled:!1,lineAccessToken:process.env.LINE_CHANNEL_ACCESS_TOKEN,emailConfig:{smtpHost:process.env.SMTP_HOST||"smtp.gmail.com",smtpPort:parseInt(process.env.SMTP_PORT||"587"),smtpUser:process.env.SMTP_USER||"",smtpPassword:process.env.SMTP_PASSWORD||"",fromEmail:process.env.FROM_EMAIL||"noreply@nursery.com",fromName:process.env.FROM_NAME||"園芸用品予約システム"}}}static async sendReservationConfirmation(e){try{let{data:s,error:t}=await l.OQ.from("reservations").select(`
          *,
          customer:customers(*),
          reservation_items(
            *,
